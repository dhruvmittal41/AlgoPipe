...
class Bagging(BaseModule):
    name = "Bagging"
    description = "Bagging Classifier using scikit-learn"
    ...
    def get_code(self, variable_name="model"):
        return (
            ...
            f"{variable_name} = BaggingClassifier(base_model, n_estimators=100, random_state=42)\n"
