...
class QuadraticDiscriminantAnalysis(BaseModule):
    name = "Quadratic Discriminant Analysis"
    description = "Quadratic Discriminant Analysis Classifier using scikit-learn"
    ...
    def get_code(self, variable_name="model"):
        return (
            ...
            f"{variable_name} = QuadraticDiscriminantAnalysis()\n"
