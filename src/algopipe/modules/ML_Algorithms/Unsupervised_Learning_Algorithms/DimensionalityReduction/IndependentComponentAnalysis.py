...
class IndependentComponentAnalysis(BaseModule):
    name = "Independent Component Analysis"
    description = "Independent Component Analysis for Dimensionality Reduction using scikit-learn"
    ...
    def get_code(self, variable_name="model"):
        return (
            ...
            f"{variable_name} = FastICA(n_components=2, random_state=42)\n"
